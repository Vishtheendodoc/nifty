...
ACCESS_TOKEN= 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJpc3MiOiJkaGFuIiwicGFydG5lcklkIjoiIiwiZXhwIjoxNzQ1NDczODIyLCJ0b2tlbkNvbnN1bWVyVHlwZSI6IlNFTEYiLCJ3ZWJob29rVXJsIjoiIiwiZGhhbkNsaWVudElkIjoiMTEwMDI0NDI2OCJ9.V10gnycFrsufjkCLEVOTiAoZx5mvlrD7XkS6n73NH-L0wdcTmBP1iNQRgcNsFJRQ-gNU4X9CdgVm95wHSPmkYg'  # Replace with your Access Token
...
IV_SPIKE_THRESHOLD = 10  # IV increase threshold (%)
IV_CRASH_THRESHOLD = 5   # IV drop threshold (%)
OI_SPIKE_THRESHOLD = 20  # OI increase threshold (%)
...
def analyze_data(option_chain):
    ...
    min_strike = atm_strike - 4 * 50  # Assuming 50-point strike intervals
    max_strike = atm_strike + 4 * 50
        ...
        if option_chain:
            ...
            with col2:
                with oi_chart_placeholder.container():
                    ...
                    fig_oi = px.bar(df, x="StrikePrice", y="OI", color="Type", title="OI vs Strike Price")
